  ...
  useEffect(() => {
    async function cargarCatalogos() {
      ...
      */
      ...
      setProductos(mockProds);

      const mockProv = [
        { id: 1, nombre: "Reciclados Sur", cuit: "30-11111111-9" },
        { id: 2, nombre: "EcoPackaging S.A.", cuit: "30-22222222-9" },
        { id: 3, nombre: "Packaging Supplies", cuit: "30-33333333-9" },
      ];
      setProveedores(mockProv);
    }
  ...
  useEffect(() => {
    ...
    async function cargarCompra() {
      ...
      */
      ...
      // --- MOCK LOAD FOR DEMO (Example ID 1) ---
      if (id === "1") {
        setProveedor("1");
        setFecha("2026-02-15");
        setObs("Carga inicial demo");
        setItems([
          {
            id: crypto.randomUUID(),
            prodId: 1,
                ...
                >
                  ...
                  <div className="grid grid-cols-2 gap-2 text-sm text-gray-600 mb-2">
                    ...
                    <div>
                      Precio:{" "}
                      <span className="font-semibold">
                        ${Number(row.precioUnit).toLocaleString("es-AR")}
                      </span>
                    </div>
                  </div>
                  {row.obs && (
