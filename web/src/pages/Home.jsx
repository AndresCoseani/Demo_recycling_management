...
export default function Home() {
  ...
  useEffect(() => {
    ...
    */
    ...
    setSummary({
      ventasMes: { total: 1245700, cantidad: 42 },
      comprasMes: { total: 850200, cantidad: 15 },
      pesajesMes: { kilos_totales: 4250.5, movimientos: 84 },
      stockCritico: { sin_stock: 2, productos_activos: 18 },
    });
  }, [isAdmin]);
    ...
    <main className="dn-home-page">
      <div className="max-w-6xl mx-auto px-4 pb-3 md:pb-5">
        ...
        <div className="dn-home-header flex flex-col items-center gap-4 my-4 md:my-6">
          <img
            src={logo}
            alt="Reciclados Demo — Packaging Sustentable"
            className="dn-home-logo w-32 h-32 md:w-40 md:h-40 lg:w-48 lg:h-48 object-contain rounded-full"
          />
          <h2 className="dn-home-title text-2xl md:text-3xl lg:text-4xl font-bold text-emerald-900"></h2>
        </div>
