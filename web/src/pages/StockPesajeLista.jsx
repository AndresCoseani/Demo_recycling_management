    ...
    const mockPesajes = [
      {
        ...
        precio_kg: 120,
        subtotal: 144000,
        observaciones: "Ingreso por compra #1",
      },
      {
        id_pesaje: 503,
        fecha: "2026-02-22T09:30:00Z",
        ...
        precio_kg: 210,
        subtotal: 178500,
        observaciones: "Carga de camión",
      },
      {
        id_pesaje: 504,
        fecha: "2026-02-21T15:45:00Z",
        producto: "Cartón Corrugado",
        tipo_mov: "AJUSTE",
        cantidad: 25,
        unidad: "kg",
                ...
                return (
                  ...
                  >
                    <div className="flex justify-between items-start mb-2">
                      <h4 className="font-bold text-[#154734] text-base">
                        {r.producto}
                      </h4>
                      <span className="text-xs text-gray-400">
                        {formatFechaConHora(r.fecha)}
                      </span>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-2 text-sm text-gray-700 mb-2">
                      <div>
                        ...
                        <span
                          className={`font-medium ${r.tipo_mov === "ENTRADA" ? "text-emerald-700" : r.tipo_mov === "SALIDA" ? "text-red-700" : ""}`}
                        >
                          {movLabel(r.tipo_mov)}
                        </span>
                      </div>
