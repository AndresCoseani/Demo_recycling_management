...
export default function Compras() {
  ...
  useEffect(() => {
    async function fetchCompras() {
      ...
      */
      ...
      const mapped = mockCompras.map(mapCompraFromApi);
      setRows(mapped);
      setLoading(false);
    }
  ...
  const visibleRowsMobile = filtered.slice(
    startMobile,
                  ...
                  >
                    ...
                    {!isAnulada && (
                      <div className="flex gap-2 mt-2 pt-2 border-t border-gray-100">
                        ...
                        <button
                          onClick={() =>
                            navigate(`/compras/editar/${numericId}`)
                          }
                          className="flex-1 text-xs text-[#154734] font-medium py-2 bg-gray-50 rounded hover:bg-gray-100"
                        >
                          Editar
