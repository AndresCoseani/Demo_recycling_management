...
export default function SegAuditoria() {
  ...
  const loadEvents = useCallback(async () => {
    ...
    setError(null);
    try {
      const queryString = tab === "Todo" ? "" : `?tab=${encodeURIComponent(tab)}`;
    ...
    const mockEvents = [
      {
        ...
        fecha: "2026-02-23T09:15:30Z",
      },
      {
        id: 102,
        tipo: "STOCK_UPDATE",
        modulo: "STOCK",
        usuario: "operario@gmail.com",
        detalle: "Actualización de stock: Cartón Corrugado (+1000kg)",
        fecha: "2026-02-23T10:20:00Z",
      },
      {
        id: 103,
        tipo: "SALE_CREATE",
        modulo: "VENTAS",
        usuario: "paula@gmail.com",
        detalle: "Nueva venta registrada: #42 (Caja Pritty)",
        fecha: "2026-02-23T11:05:15Z",
      },
      {
        id: 104,
        tipo: "USER_MODIFIED",
        modulo: "SEGURIDAD",
        usuario: "admin@gmail.com",
        detalle: "Se modificó el rol del usuario Paula",
        fecha: "2026-02-23T11:45:00Z",
      },
      {
        id: 105,
        tipo: "PURCHASE_REGISTER",
        modulo: "COMPRAS",
        usuario: "admin@gmail.com",
        detalle: "Nueva compra registrada a Reciclados Sur",
  ...
  const nextMobile = () =>
    setMobilePage((p) => Math.min(maxMobilePages, p + 1));
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-lg border text-sm font-medium ${
                    mobilePage === 1
                      ...
                      : "bg-white text-[#154734] border-[#154734]"
                  }`}
                >
                  Anterior
                </button>
