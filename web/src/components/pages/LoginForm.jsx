...
export default function LoginForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (DEMO_MODE) {
        console.log("DEMO MODE LOGIN", mail, password);
        if (mail === "admin@gmail.com" && password === "admin1234") {
          const demoUser = {
            rol: "admin",
            nombre: "Admin Demo",
            email: mail,
          ...
          localStorage.setItem("dn_role", demoUser.rol);
          localStorage.setItem("dn_user_name", demoUser.nombre);
